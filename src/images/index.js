...
import alphaLegionHeadHunter from './alpha-legion-head-hunter.svg'
...
import daemonicHordesBloodcrushers from './daemonic-hordes-bloodcrushers.svg'
import daemonicHordesBloodletters from './daemonic-hordes-bloodletters.svg'
...
import daemonicHordesDaemonPrinceOfTzeench from './daemonic-hordes-daemon-prince-of-tzeench.svg'
import daemonicHordesDaemonettes from './daemonic-hordes-daemonettes.svg'
import daemonicHordesFiendsOfSlaanesh from './daemonic-hordes-fiends-of-slaanesh.svg'
import daemonicHordesFlamersOfTzeench from './daemonic-hordes-flamers-of-tzeench.svg'
import daemonicHordesFleshHounds from './daemonic-hordes-flesh-hounds.svg'
import daemonicHordesGreatUncleanOne from './daemonic-hordes-great-unclean-one.svg'
import daemonicHordesHeraldOfKhorne from './daemonic-hordes-herald-of-khorne.svg'
import daemonicHordesHeraldOfNurgle from './daemonic-hordes-herald-of-nurgle.svg'
import daemonicHordesHeraldOfSlaanesh from './daemonic-hordes-herald-of-slaanesh.svg'
import daemonicHordesHeraldOfTzeench from './daemonic-hordes-herald-of-tzeench.svg'
import daemonicHordesHorrorsOfTzeench from './daemonic-hordes-horrors-of-tzeench.svg'
import daemonicHordesKeeperOfSecrets from './daemonic-hordes-keeper-of-secrets.svg'
import daemonicHordesKhorne from './daemonic-hordes-khorne.svg'
import daemonicHordesLordOfChange from './daemonic-hordes-lord-of-change.svg'
import daemonicHordesNurgle from './daemonic-hordes-nurgle.svg'
import daemonicHordesNurglings from './daemonic-hordes-nurglings.svg'
import daemonicHordesPlagueBearers from './daemonic-hordes-plague-bearers.svg'
import daemonicHordesPlagueDrones from './daemonic-hordes-plague-drones.svg'
import daemonicHordesScreamersOfTzeench from './daemonic-hordes-screamers-of-tzeench.svg'
import daemonicHordesSeekerChariot from './daemonic-hordes-seeker-chariot.svg'
...
import emperorsChildrenKakophoni from './emperors-children-kakophoni.svg'
import emperorsChildrenPalatineBlades from './emperors-children-palatine-blades.svg'
import emperorsChildrenPhoenixTerminator from './emperors-children-phoenix-terminator.svg'
...
import imperialFistsSuperHeavyTankSquadron from './imperial-fists-super-heavy-tank-squadron.svg'
import imperialFistsTemplarBrethren from './imperial-fists-templar-brethren.svg'
import imperialFists from './imperial-fists.svg'
import imperialMilitiaArvusLighter from './imperial-militia-arvus-lighter.svg'
import imperialMilitiaAuxiliaries from './imperial-militia-auxiliaries.svg'
import imperialMilitiaAvenger from './imperial-militia-avenger.svg'
...
import imperialMilitiaEmperorClassBattleship from './imperial-militia-emperor-class-battleship.svg'
import imperialMilitiaFireSupport from './imperial-militia-fire-support.svg'
...
import ironHandsMedusanImmortals from './iron-hands-medusan-immortals.svg'
import ironHandsPredatorExecutioner from './iron-hands-predator-executioner.svg'
...
import knightHouseholdQuestorisKnightErrant from './knight-household-questoris-knight-errant.svg'
import knightHouseholdQuestorisKnightGallant from './knight-household-questoris-knight-gallant.svg'
import knightHouseholdQuestorisKnightMagera from './knight-household-questoris-knight-magera.svg'
import knightHouseholdQuestorisKnightPaladin from './knight-household-questoris-knight-paladin.svg'
import knightHouseholdQuestorisKnightStyrix from './knight-household-questoris-knight-styrix.svg'
import knightHouseholdQuestorisKnightWarden from './knight-household-questoris-knight-warden.svg'
import knightHouseholdQuestoris from './knight-household-questoris.svg'
import knightHouseholdSeneschal from './knight-household-seneschal.svg'
...
import legioTitanicusLegate from './legio-titanicus-legate.svg'
import legioTitanicusReaver from './legio-titanicus-reaver.svg'
...
import legionChampion from './legion-champion.svg'
import legionChaplain from './legion-chaplain.svg'
import legionContemptorDreadnought from './legion-contemptor-dreadnought.svg'
...
import mechanicumTaghmataLandRaider from './mechanicum-taghmata-land-raider.svg'
import mechanicumTaghmataMagosPrime from './mechanicum-taghmata-magos-prime.svg'
import mechanicumTaghmataMinotaur from './mechanicum-taghmata-minotaur.svg'
import mechanicumTaghmataMyrmidonDestructors from './mechanicum-taghmata-myrmidon-destructors.svg'
import mechanicumTaghmataMyrmidon from './mechanicum-taghmata-myrmidon.svg'
import mechanicumTaghmataOrdinatusMajoris from './mechanicum-taghmata-ordinatus-majoris.svg'
import mechanicumTaghmataOrdinatusMinoris from './mechanicum-taghmata-ordinatus-minoris.svg'
import mechanicumTaghmataPrimaris from './mechanicum-taghmata-primaris.svg'
import mechanicumTaghmataScyllax from './mechanicum-taghmata-scyllax.svg'
...
import salamandersFiredrake from './salamanders-firedrake.svg'
import salamandersPrimarch from './salamanders-primarch.svg'
import salamandersPyroclast from './salamanders-pyroclast.svg'
...
import sonsOfHorusPrimarch from './sons-of-horus-primarch.svg'
import sonsOfHorusReaver from './sons-of-horus-reaver.svg'
import sonsOfHorus from './sons-of-horus.svg'
import spaceWolvesDeathsworn from './space-wolves-deathsworn.svg'
import spaceWolvesGreySlayer from './space-wolves-grey-slayer.svg'
import spaceWolvesPrimarch from './space-wolves-primarch.svg'
import spaceWolvesVaragyr from './space-wolves-varagyr.svg'
import spaceWolves from './space-wolves.svg'
import thousandSonsAmmitara from './thousand-sons-ammitara.svg'
import thousandSonsKhenetai from './thousand-sons-khenetai.svg'
...
const IMAGES = {
  'alpha-legion-head-hunter': alphaLegionHeadHunter,
  ...
  'daemonic-hordes-bloodcrushers': daemonicHordesBloodcrushers,
  'daemonic-hordes-bloodletters': daemonicHordesBloodletters,
  ...
  'daemonic-hordes-daemon-prince-of-tzeench': daemonicHordesDaemonPrinceOfTzeench,
  'daemonic-hordes-daemonettes': daemonicHordesDaemonettes,
  'daemonic-hordes-fiends-of-slaanesh': daemonicHordesFiendsOfSlaanesh,
  'daemonic-hordes-flamers-of-tzeench': daemonicHordesFlamersOfTzeench,
  'daemonic-hordes-flesh-hounds': daemonicHordesFleshHounds,
  'daemonic-hordes-great-unclean-one': daemonicHordesGreatUncleanOne,
  'daemonic-hordes-herald-of-khorne': daemonicHordesHeraldOfKhorne,
  'daemonic-hordes-herald-of-nurgle': daemonicHordesHeraldOfNurgle,
  'daemonic-hordes-herald-of-slaanesh': daemonicHordesHeraldOfSlaanesh,
  'daemonic-hordes-herald-of-tzeench': daemonicHordesHeraldOfTzeench,
  'daemonic-hordes-horrors-of-tzeench': daemonicHordesHorrorsOfTzeench,
  'daemonic-hordes-keeper-of-secrets': daemonicHordesKeeperOfSecrets,
  'daemonic-hordes-khorne': daemonicHordesKhorne,
  'daemonic-hordes-lord-of-change': daemonicHordesLordOfChange,
  'daemonic-hordes-nurgle': daemonicHordesNurgle,
  'daemonic-hordes-nurglings': daemonicHordesNurglings,
  'daemonic-hordes-plague-bearers': daemonicHordesPlagueBearers,
  'daemonic-hordes-plague-drones': daemonicHordesPlagueDrones,
  'daemonic-hordes-screamers-of-tzeench': daemonicHordesScreamersOfTzeench,
  'daemonic-hordes-seeker-chariot': daemonicHordesSeekerChariot,
  ...
  'emperors-children-kakophoni': emperorsChildrenKakophoni,
  'emperors-children-palatine-blades': emperorsChildrenPalatineBlades,
  'emperors-children-phoenix-terminator': emperorsChildrenPhoenixTerminator,
  ...
  'imperial-fists-super-heavy-tank-squadron': imperialFistsSuperHeavyTankSquadron,
  'imperial-fists-templar-brethren': imperialFistsTemplarBrethren,
  'imperial-fists': imperialFists,
  'imperial-militia-arvus-lighter': imperialMilitiaArvusLighter,
  'imperial-militia-auxiliaries': imperialMilitiaAuxiliaries,
  'imperial-militia-avenger': imperialMilitiaAvenger,
  ...
  'imperial-militia-emperor-class-battleship': imperialMilitiaEmperorClassBattleship,
  'imperial-militia-fire-support': imperialMilitiaFireSupport,
  ...
  'iron-hands-medusan-immortals': ironHandsMedusanImmortals,
  'iron-hands-predator-executioner': ironHandsPredatorExecutioner,
  ...
  'knight-household-questoris-knight-errant': knightHouseholdQuestorisKnightErrant,
  'knight-household-questoris-knight-gallant': knightHouseholdQuestorisKnightGallant,
  'knight-household-questoris-knight-magera': knightHouseholdQuestorisKnightMagera,
  'knight-household-questoris-knight-paladin': knightHouseholdQuestorisKnightPaladin,
  'knight-household-questoris-knight-styrix': knightHouseholdQuestorisKnightStyrix,
  'knight-household-questoris-knight-warden': knightHouseholdQuestorisKnightWarden,
  'knight-household-questoris': knightHouseholdQuestoris,
  'knight-household-seneschal': knightHouseholdSeneschal,
  ...
  'legio-titanicus-legate': legioTitanicusLegate,
  'legio-titanicus-reaver': legioTitanicusReaver,
  ...
  'legion-champion': legionChampion,
  'legion-chaplain': legionChaplain,
  'legion-contemptor-dreadnought': legionContemptorDreadnought,
  ...
  'mechanicum-taghmata-land-raider': mechanicumTaghmataLandRaider,
  'mechanicum-taghmata-magos-prime': mechanicumTaghmataMagosPrime,
  'mechanicum-taghmata-minotaur': mechanicumTaghmataMinotaur,
  'mechanicum-taghmata-myrmidon-destructors': mechanicumTaghmataMyrmidonDestructors,
  'mechanicum-taghmata-myrmidon': mechanicumTaghmataMyrmidon,
  'mechanicum-taghmata-ordinatus-majoris': mechanicumTaghmataOrdinatusMajoris,
  'mechanicum-taghmata-ordinatus-minoris': mechanicumTaghmataOrdinatusMinoris,
  'mechanicum-taghmata-primaris': mechanicumTaghmataPrimaris,
  'mechanicum-taghmata-scyllax': mechanicumTaghmataScyllax,
  ...
  'salamanders-firedrake': salamandersFiredrake,
  'salamanders-primarch': salamandersPrimarch,
  'salamanders-pyroclast': salamandersPyroclast,
  ...
  'sons-of-horus-primarch': sonsOfHorusPrimarch,
  'sons-of-horus-reaver': sonsOfHorusReaver,
  'sons-of-horus': sonsOfHorus,
  'space-wolves-deathsworn': spaceWolvesDeathsworn,
  'space-wolves-grey-slayer': spaceWolvesGreySlayer,
  'space-wolves-primarch': spaceWolvesPrimarch,
  'space-wolves-varagyr': spaceWolvesVaragyr,
  'space-wolves': spaceWolves,
  'thousand-sons-ammitara': thousandSonsAmmitara,
  'thousand-sons-khenetai': thousandSonsKhenetai,
